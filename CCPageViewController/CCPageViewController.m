...
+ (UIColor *) skyBlueColor {
    return [CCPageViewController colorWithHex:0x5cbfbe];
}

+ (UIColor *) defaultMenuBorderColor {
    return [CCPageViewController colorWithHex:0xeeeeee];
}
...
- (void)viewDidLoad {
    ...
    _menu.showBorderline = YES;
    _menu.borderLineColor = [CCPageViewController defaultMenuBorderColor];
...
- (NSUInteger) selectedIndex {
    return _contentsView.currentIndex;
}
